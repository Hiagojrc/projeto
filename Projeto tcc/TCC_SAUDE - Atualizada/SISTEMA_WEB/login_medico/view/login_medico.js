...
function acessar() {
    ...
    let url = "http://localhost/projeto_tcc/TCC_SAUDE/BACK_END/src/controll/routes/route.usuarioM.php";
        ...
        xhr.addEventListener("readystatechange", function () {
            if (this.readyState === this.DONE) {
                ...
                if (resp.hasOwnProperty("erro")) {
                    ...
                    window.location.href = destino + "?Crm=" + resp.crm + "&crm=" + resp.idArea_medico;
                }
